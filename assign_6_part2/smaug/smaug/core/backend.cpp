...
// declare custom operators in reference backend
...
// declare custom operators in SMV backend
...
// for my custom operator homework
// accelerator id is 0x0006
const unsigned kMyCustomOperatorHw = 0x0006;
// define scratchpad size
int kSpadSize;
float* spad0;
float* spad1;
}  // namespace ref
...
// for my custom operator homework
const unsigned kMyCustomOperatorHw = 0x0003;
}  // namespace smv
